...
import { Bot, LineChart, Package, Users, History, Receipt, Check, X, Truck, Mail, Headphones, Sparkles, Building2, BarChart2 } from 'lucide-react';
...
export default async function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-600 font-sans selection:bg-emerald-500/30">
